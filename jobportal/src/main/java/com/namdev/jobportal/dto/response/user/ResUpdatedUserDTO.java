package com.namdev.jobportal.dto.response.user;

import java.time.Instant;

import com.namdev.jobportal.util.constant.GenderEnum;

//DTO này dùng để trả về thông tin của user sau khi đã được cập nhật thành công
